...
@app.route('/entries/entrys/<entry_id>', methods=['GET', 'POST'])
...
@app.route('/entries/entry/<entry_id>/<item_id>', methods=['GET', 'POST'])
...
@app.route('/entries/entry/delete/<entry_id>/<item_id>', methods=['GET', 'POST'])
