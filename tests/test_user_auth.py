...
class TestUserAuthentication(unittest.TestCase):
    ...
    def setUp(self):
        self.user = User('koitoror', '12345', 'kamarster')
        self.app = Application()

    def test_user_is_added_to_dictionary_when_created(self):
        self.assertTrue(self.app.register_user(User('kamar1', '12345', 'kamarster')))
    ...
    def test_user_trying_to_login_has_entered_a_correct_password(self):
        self.app.users = {'koitoror': self.user}
        self.assertTrue(self.app.login_user('koitoror', '12345'))
